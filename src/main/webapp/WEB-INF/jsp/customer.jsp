...
<body>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="customer.action" class="active"><i class="fa fa-edit fa-fw"></i> 客户管理</a></li>
					<%--<li><a href="salevisit.action"><i class="fa fa-dashboard fa-fw"></i> 项目管理</a></li>--%>
					<li><a href="customer.action" class="active"><i class="fa fa-edit fa-fw"></i> 项目管理</a></li>
					<li><a href="customer.action" class="active"><i class="fa fa-edit fa-fw"></i> 主机管理</a></li>
				</ul>
			</div>
			<!-- /.sidebar-collapse -->
		</div>
					...
					<form class="form-horizontal" id="edit_customer_form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<%--<input type="text" class="form-control" id="edit_linkMan" placeholder="联系人" name="cust_linkman" value="titan">--%>
							</div>
						</div>
						<div class="form-group">
	...
	<script type="text/javascript">
		...
		function updateCustomer() {
			$.post("<%=basePath%>customer/edit.do",$("#edit_customer_form").serialize(),function(data){
//				alert("客户信息更新成功！");
